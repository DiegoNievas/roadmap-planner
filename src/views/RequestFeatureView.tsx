...
export default function RequestFeatureView() {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <form onSubmit={handleSubmit} className="space-y-8 bg-card border p-6 md:p-10 rounded-3xl" style={{ background: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 space-y-2">
            <label className="text-sm font-semibold text-slate-300">Request Title *</label>
            <input 
              required
              type="text" 
              placeholder="e.g. Add Multi-cloud cost reporting to Azure Portfolio"
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all placeholder:text-slate-600 shadow-inner"
              value={form.title}
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Portfolio</label>
            <select 
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Product / Service</label>
            <select 
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Request Type *</label>
            <select 
              required
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
              value={form.type}
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <textarea 
              ...
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all placeholder:text-slate-600 shadow-inner resize-none"
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Business Justification *</label>
            <textarea 
              required
              placeholder="Why is this needed? What problem does it solve?"
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all placeholder:text-slate-600 shadow-inner min-h-[100px]"
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Expected Benefit *</label>
            <textarea 
              required
          ...
          <div className="md:col-span-2 mt-4">
            ...
            <h3 className="text-lg font-bold text-white mb-6">Submitter Information</h3>
          </div>
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Team / Function *</label>
            <input 
              required
              type="text" 
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-slate-300">Strategic Alignment</label>
            <select 
              className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
        ...
        <div className="pt-4">
          <button 
            ...
            className="w-full md:w-auto px-10 py-4 bg-indigo-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-600/20 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            {isSubmitting ? (
